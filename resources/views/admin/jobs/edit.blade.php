...
<div class="flex">
    ...
    <div class="flex-1 p-8">
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <form action="{{ route('admin.lowongan.update', $job) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <div class="mt-1 flex items-center">
                        @if ($job->image_path)
                            <div class="mr-4">
                                <img src="{{ asset('storage/' . $job->image_path) }}" alt="{{ $job->title }}" class="h-20 w-20 object-cover rounded">
